    ...
    devServer.app.post('/edit-file', (req, res) => {
      ...
      try {
        ...
        Object.entries(changesByFile).forEach(([fileName, fileChanges]) => {
          ...
          const isInFrontend =
            normalizedTarget.startsWith(frontendRoot) && !normalizedTarget.includes('..');
          const isNodeModules = normalizedTarget.includes('node_modules');
          const isPublic =
            normalizedTarget.includes('/public/') || normalizedTarget.endsWith('/public');
            ...
            JSXOpeningElement: (path) => {
              ...
              changesAtLine.forEach((change) => {
                ...
                if (change.type === 'className' && change.className !== undefined) {
                  ...
                  console.log(`[backend] Processing className change:`, change.className);
                  ...
                  if (classAttr) {
                    ...
                    console.log(`[backend] Creating new className attribute:`, change.className);
                  ...
                  console.log(`[backend] Processing textContent change:`, change.textContent);
                  ...
                  if (parentElementPath && parentElementPath.isJSXElement()) {
                    ...
                    if (firstTextNode) {
                      ...
                      firstTextNode.value = preserveWhitespace(firstTextNode.value, newContent);
                  ...
                  console.error(`[backend] This change will be IGNORED to prevent contamination.`);
                }
              });
